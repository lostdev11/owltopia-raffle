    ...
    return (
      <div className="container mx-auto py-8 px-4">
        <Card className="max-w-lg mx-auto">
          <CardHeader>
            <CardTitle>NFT giveaways</CardTitle>
            <CardDescription>Connect an admin wallet to manage giveaways.</CardDescription>
          </CardHeader>
          <CardContent>
  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-4xl">
      ...
      <p className="text-muted-foreground text-sm mb-8">
        Send the NFT to the <span className="text-foreground font-medium">prize escrow</span> (same as raffles), then
