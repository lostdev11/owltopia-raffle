    ...
    <div className="container mx-auto max-w-4xl py-8 px-4 space-y-6">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground max-w-2xl">
          Open from Owl Vision → <strong className="text-foreground">Partners</strong> → Nest requests (
          <span className="font-mono text-xs">/admin/partners/nest-applications</span>
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          <Button asChild variant="outline" size="sm" className="min-h-[40px]">
            <Link href="/admin/partners/nesting">Manual Partner Nesting</Link>
          </Button>
          <Button asChild variant="outline" size="sm" className="min-h-[40px]">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    {row.approved_pool_id ? (
                      <Button asChild size="sm" variant="outline" className="min-h-[40px]">
                        <Link href="/admin/partners/nesting">View partner pools</Link>
                      </Button>
                    ) : null}
                  </div>
                </li>
