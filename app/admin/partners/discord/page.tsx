  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-4xl">
      ...
      <p className="text-muted-foreground text-sm mb-8">
        To attach a server to an allowlisted Partner Pro wallet in one step, use{' '}
      ...
      <Card className="mb-10">
        ...
        <CardContent>
          <form onSubmit={handleCreate} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="p-wh">Discord incoming webhook URL (optional if server ID set)</Label>
              <Input
                id="p-wh"
            ...
            <div className="space-y-2">
              <Label htmlFor="p-guild">Discord server ID (optional if webhook set)</Label>
              <Input
                id="p-guild"
