      ...
      <div className="prose prose-invert max-w-none">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 mb-4 space-y-2">
            ...
            <li>New raffles require a <strong>maximum ticket limit</strong> set by the creator at listing time (older unlimited listings may still exist). Once the cap is reached, no additional entries can be purchased</li>
            <li>When the maximum ticket limit is reached and the draw threshold is met, the winner draw may run <strong>before</strong> the scheduled end time</li>
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 mb-4 space-y-2">
            ...
            <li>If a <strong>minimum ticket threshold</strong> is set, a winner can be selected once <strong>confirmed</strong> ticket sales meet or exceed that threshold and other eligibility checks pass — including when the maximum ticket cap is sold out before the scheduled end time. There is <strong>no</strong> separate mandatory multi-day waiting period after the minimum is met solely for that reason</li>
