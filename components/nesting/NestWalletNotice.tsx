...
import {
  ...
  NEST_WALLET_NOTICE_TEASER,
  nestWalletNoticeDelegateLine,
} from '@/lib/nesting/nest-wallet-notice'

/** Quiet pre-sign note — Phantom/Jupiter-style matter-of-fact, not a security alarm. */
export function NestWalletNotice({
  ...
  return (
    <div className={className}>
      <p className="px-1 text-xs leading-relaxed text-muted-foreground" role="note">
        {NEST_WALLET_NOTICE_TEASER}
      </p>
