        ...
        {phases.map((p, i) => {
          ...
          return (
            <li
              key={p}
              className={cn(
                'relative flex min-h-[44px] min-w-0 flex-1 flex-col items-center justify-center px-3 py-2 font-mono text-[10px] font-bold uppercase tracking-widest md:flex-none md:items-start md:justify-center md:px-4',
                done && !isUserMint && 'text-[#00FF9C]',
                current && !done && !isUserMint && 'bg-[#00FF9C]/10 text-[#00FF9C]',
                isUserMint &&
                  'bg-[#00FF9C]/15 text-[#00FF9C] ring-2 ring-inset ring-[#00FF9C]/70 md:ring-offset-2 md:ring-offset-[#0B0F14]',
