...
1. User pays pack price → tx confirms (pack visual pulses / seal spins)
...
4. When the video ends (or user skips) **and** the open result is ready → animated prize reveal + confetti
