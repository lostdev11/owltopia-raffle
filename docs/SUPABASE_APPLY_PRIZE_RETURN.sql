-- =============================================================================
-- Apply prize return to creator (run in Supabase SQL Editor)
-- =============================================================================
-- This adds columns for the "Return prize to creator" feature (admin-only).
-- Safe to run: uses IF NOT EXISTS. Corresponds to migration 036_add_prize_return_fields.sql.
-- =============================================================================
