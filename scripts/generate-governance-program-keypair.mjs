...
console.log('')
console.log('- If mainnet/deployed program id is still FwEAjseYTP6vTp9g6SpBTgySWzm4yxCtBc3Ti7Rvcfyz, ONLY that')
console.log("  matching secret key can redeploy/upgrades unless you migrate to a new program id.")
console.log('- If this is a ROTATION after a leaked keypair: deploy a NEW program with this id, then update')
console.log('  declare_id!, Anchor.toml, lib/governance/config.ts DEFAULT_GOVERNANCE_PROGRAM_ID and')
console.log('  NEXT_PUBLIC_GOVERNANCE_PROGRAM_ID, then migrate vault / migrate user-facing flows.')
console.log('')
