...
export const GEN2_MINT_WALLET_NOTICE_SUMMARY =
  'Owltopia Gen2 mints are frozen NFTs (tradeable after mint-out thaw). Some wallets — especially Jupiter — show scary red warnings about “mint authority” or “freeze authority.” That is usually a false alarm for this mint, not a hack.'
...
export const GEN2_MINT_WALLET_NOTICE_BULLETS = [
  ...
  'The NFT mints frozen on purpose until mint-out — then the collection thaws automatically (team can also thaw from admin).',
