...
export const NESTING_SECURITY_BULLETS: readonly string[] = [
  ...
  'Some wallets (especially Jupiter) say nesting “can spend tokens from your wallet.” That is their label for the nest freeze Approve on the owl you picked — not a blank check on your SOL. Phantom/Solflare usually word the same step more clearly; the NFT stays in your wallet.',
