...
/**
 * @deprecated Monthly Discord USDC renewals discontinued. Kept for older admin tooling / DB rows.
 * When a Discord guild already has a partner tenant row, use the lowest active linked USDC quote, or null.
 */
